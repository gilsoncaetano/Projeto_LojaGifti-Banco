...
/*
O arquivo pagamento.php foi será incluido para que a classe Foto 
...
/*
A estrutra while(equanto) realiza a busca de todos os pagamento cadastrados
até chegar ao final da tabela e tras os dados para fetch array organizar 
em formato de array
Assim será mais fácil de adcionar no array de pagamento para apresentar 
ao final
*/
    ...
    header("HTTP/1.0 400");
    echo json_encode(array("mensagem"=>"Não há Produtos para o pagamento "));
}
?>